...
//side navbar//
let elementW =  $('#sidenav').outerWidth(true);
let navTop = $('#sidenav ul').css('top');
$('#sidenav').css('left','-'+ elementW);

$('#open').click(function open(){

    if($('#open-nav').css('left')=='0px'){
        $('#open-nav').animate({left: elementW});
...
function searchF(){
  $('#searchLoadScreen').css('display' , 'flex');
    ...
    <div id="varContent" class="background overflow-auto">
    <div div id="" class=" container justify-content-center  background py-4 ">
    <div class="row g-3">

      <div class="col-md-6">
        <input type="text" placeholder="Search By Name"  class="form-control background search text-white" id="searchN" onkeyup="searchByName()">

      </div>
      <div class="col-md-6">
    <input type="text" placeholder="Search By First Letter" class="form-control background search text-white mb-4" id="searchL" maxlength="1" onkeyup="searchByLetter()">
...
async function displayCat(){
  ...
  $('#view').html(`<div  id="varContent" class="background overflow-auto">
  <div class="container ">
...
function openContact(){
  $('#view').html(`<div id="varContent" class="background overflow-auto overflow-x-hidden d-flex align-items-center">

        
  <div id="" class=" container justify-content-center align-items-center w-50  background py-4 ">
